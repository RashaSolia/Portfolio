    ...
    <section className="flex hero" id="hero">
      <div className="left-section">
        ...
        <p className="subtitle">
          Hi, I’m Rasha — a front-end developer with a background in
          engineering.
          <br />
        ...
        <div className="allIcons flex">
          ...
          <a
            href="https://www.instagram.com/rashasolia/"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://github.com/RashaSolia"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://www.linkedin.com/in/rashasolia1112/"
            target="_blank"
            rel="noopener noreferrer"
          >
